...
- Per ciascuno dei progetti Laravel successivi al primo (laraProj2, laraProj3, ...):
  ...
  + creare l'utente user=tweb, pass=tweb nel DBMS e abilitarlo all'accesso al DB
    laraProj<X>_DB 
  + popolare il DB attivando le migrazioni del progetto tramite il comando artisan 
    "php artisan migrate" 
- Accedere all'applicazione tramite l'URL http://localhost/laraProj<X>/public