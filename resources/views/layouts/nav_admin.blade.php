                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('eliminaStaff') }}">Cancella staff</a></li>                                  
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('eliminaUtente') }}">Elimina Cliente</a></li>
                    </ul>
